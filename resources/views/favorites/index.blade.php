                ...
                <div class="row justify-content-center g-0">
                    <div class=" d-flex justify-content-center col-12 col-lg-4 p-3">
                        <a href="{{ route('article.show', compact('article')) }}"> <img
                                class=" img-fluid border rounded  borderimg shadowimg" src="{{$article->images->isNotEmpty()?$article->images->first()->getUrl(1200,1200):''}}" alt="Immagine dell'articolo {{$article->title}}">
                        </a>
                    </div>
